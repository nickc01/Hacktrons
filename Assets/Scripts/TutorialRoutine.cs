...
public static class TutorialRoutine
{
    ...
    public static async Task Tutorial()
    {
        try
        {
            ...
            await PrintText("Welcome new recruit, I am sure that you are new to this, would you like a quick walkthrough?");
            ...
            await PrintText("Now Click on the program you want to upload from the side panel.");
            ...
            await PrintText("Now that we uploaded a program, the battle can now begin, press the \"Start\" button to begin.");
            ...
            await PrintMessage("Also note that when your program moves, it will leave behind a trail.");
